...
- [[심층 분석] PHM Mission Control 실전 설계: 모델-검증 연계, 데이터 타입 거버넌스, 자동 실측 반영](./posts/2026-03-05-phm-mission-control-model-linked-validation-governance.md)
- [[Trending] 2026년 3월, 에이전틱 AI 생태계를 이끄는 핵심 오픈소스 TOP 4](./posts/2026-03-03-trending-ai-repos.md)
- [[심층 분석] 베어링 고장 진단의 패러다임 전환: Raw 신호 기반 1D CNN이 가져온 실무 혁신](./posts/2026-03-02-1dcnn-bearing-fault-diagnosis-cwru-paderborn.md)
...
- [[특별 기획] GitHub Copilot SDK의 정수: Repo Bootcamp 심층 분석 🏕️](./posts/2026-02-25-special-report-repo-bootcamp.md)
...
- [[심층 분석] 철도 안전의 미래: 딥러닝 기반의 주행 중 사고 및 휠 결함 탐지 기술](./posts/2026-02-23-railway-safety-deeplearning-detection.md)
